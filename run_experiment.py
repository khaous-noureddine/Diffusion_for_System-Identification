...
parser.add_argument("--predict_type", required=False, type=str)
...
num_epochs = args.n_epochs if args.n_epochs is not None else 16
models_path = f"output/exp_{args.exp_name}/models"
...
model.load_state_dict(torch.load(f"output/exp_{args.exp_name}/models/best_jit_fluid_model.pth"))
...
for i, test_case in enumerate(test_list):
    ...
    video_path = f"output/exp_{args.exp_name}/videos"
